...
export const AbilitiesList = <Array<Ability>>[
    ...
    },
    {
        "id": 94,
        "name": "solar-power",
        "description": "Boosts Sp. Atk, but\nlowers HP in sunshine.",
        "effect": "Increases Special Attack to 1.5× but costs 1/8 max HP after each turn during strong sunlight."
    },
    {
        "id": 67,
        "name": "torrent",
        "description": "Ups WATER moves in a pinch.",
        "effect": "Strengthens water moves to inflict 1.5× damage at 1/3 max HP or less."
    },
    {
        "id": 44,
        "name": "rain-dish",
        "description": "Slight HP recovery in rain.",
        "effect": "Heals for 1/16 max HP after each turn during rain."
    },
    {
        "id": 19,
        "name": "shield-dust",
    ...
    },
    {
        ...
        "effect": "Has a 33% chance of curing any major status ailment after each turn."
    },
    {
        "id": 14,
        "name": "compound-eyes",
        "description": "Raises accuracy.",
        "effect": "Increases moves' accuracy to 1.3×."
    },
    {
        "id": 110,
        "name": "tinted-lens",
        "description": "Powers up “not very\neffective” moves.",
    ...
    },
    {
        ...
        "effect": "Strengthens bug moves to inflict 1.5× damage at 1/3 max HP or less."
    },
    {
        "id": 97,
        "name": "sniper",
        "description": "Powers up moves if they\nbecome critical hits.",
        "effect": "Strengthens critical hits to inflict 3× damage rather than 2×."
    },
    {
        "id": 51,
        "name": "keen-eye",
        "description": "Prevents loss of accuracy.",
        "effect": "Prevents accuracy from being lowered."
    },
    {
        "id": 77,
        "name": "tangled-feet",
        "description": "Raises evasion if the\nPokémon is confused.",
        "effect": "Doubles evasion when confused."
    },
    {
        "id": 145,
        "name": "big-pecks",
        "description": "Protects the Pokémon from\nDefense-lowering attacks.",
        "effect": "Protects against Defense drops."
    },
    {
        "id": 62,
        "name": "guts",
        "description": "Ups ATTACK if suffering.",
        "effect": "Increases Attack to 1.5× with a major status ailment."
    },
    {
        "id": 55,
        "name": "hustle",
        "description": "Trades accuracy for power.",
        "effect": "Strengthens physical moves to inflict 1.5× damage, but decreases their accuracy to 0.8×."
    },
    {
        "id": 22,
        "name": "intimidate",
    ...
    },
    {
        "id": 127,
        "name": "unnerve",
        "description": "Makes the foe nervous and\nunable to eat Berries.",
    ...
    },
    {
        ...
        "effect": "Increases evasion to 1.25× during a sandstorm.  Protects against sandstorm damage."
    },
    {
        "id": 146,
        "name": "sand-rush",
        "description": "Boosts the Pokémon’s\nSpeed in a sandstorm.",
    ...
    },
    {
        "id": 79,
        "name": "rivalry",
        "description": "Raises Attack if the foe\nis of the same gender.",
    ...
    },
    {
        "id": 125,
        "name": "sheer-force",
        "description": "Removes added effects to\nincrease move damage.",
    ...
    },
    {
        ...
        "effect": "Protects against fire moves.  Once one has been blocked, the Pokémon's own Fire moves inflict 1.5× damage until it leaves battle."
    },
    {
        "id": 70,
        "name": "drought",
    ...
    },
    {
        "id": 172,
        "name": "competitive",
        "description": "Boosts the Sp. Atk stat when\na stat is lowered.",
        "effect": "Raises Special Attack by two stages upon having any stat lowered."
    },
    {
        "id": 119,
        "name": "frisk",
        "description": "The Pokémon can check\nthe foe’s held item.",
    ...
    },
    {
        "id": 151,
        "name": "infiltrator",
        "description": "Passes through the foe’s\nbarrier and strikes.",
    ...
    },
    {
        ...
        "effect": "Has a 30% chance of inflcting either paralysis, poison, or sleep on attacking Pokémon on contact."
    },
    {
        "id": 87,
        "name": "dry-skin",
        "description": "Reduces HP if it is hot.\nWater restores HP.",
        "effect": "Causes 1/8 max HP in damage each turn during strong sunlight, but heals for 1/8 max HP during rain.  Increases damage from fire moves to 1.25×, but absorbs water moves, healing for 1/4 max HP."
    },
    {
        "id": 6,
        "name": "damp",
        "description": "Prevents self-destruction.",
        "effect": "Prevents self destruct, explosion, and aftermath from working while the Pokémon is in battle."
    },
    {
        "id": 147,
        "name": "wonder-skin",
        "description": "Makes status-changing\nmoves more likely to miss.",
        "effect": "Lowers incoming non-damaging moves' base accuracy to exactly 50%."
    },
    {
        "id": 71,
        "name": "arena-trap",
        "description": "Prevents fleeing.",
        "effect": "Prevents opponents from fleeing or switching out.  Eluded by flying-types and Pokémon in the air."
    },
    {
        "id": 159,
        "name": "sand-force",
        "description": "Boosts certain moves’\npower in a sandstorm.",
        "effect": "Strengthens rock, ground, and steel moves to 1.3× their power during a sandstorm.  Protects against sandstorm damage."
    },
    {
        "id": 53,
        "name": "pickup",
        "description": "May pick up items.",
        "effect": "Picks up other Pokémon's used and Flung held items.  May also pick up an item after battle."
    },
    {
        "id": 101,
        "name": "technician",
        "description": "Powers up the Pokémon’s\nweaker moves.",
    ...
    },
    {
        ...
        "effect": "Negates all effects of weather, but does not prevent the weather itself."
    },
    {
        "id": 33,
        "name": "swift-swim",
    ...
    },
    {
        "id": 99,
        "name": "no-guard",
        "description": "Ensures the Pokémon and\nits foe’s attacks land.",
        "effect": "Ensures all moves used by and against the Pokémon hit."
    },
    {
        "id": 80,
        "name": "steadfast",
        "description": "Raises Speed each time\nthe Pokémon flinches.",
        "effect": "Raises Speed one stage upon flinching."
    },
    {
        "id": 82,
        "name": "gluttony",
        "description": "Encourages the early use\nof a held Berry.",
        "effect": "Makes the Pokémon eat any held Berry triggered by low HP below 1/2 its max HP."
    },
    {
        "id": 29,
        "name": "clear-body",
    ...
    },
    {
        "id": 69,
        "name": "rock-head",
        "description": "Protects the Pokémon\nfrom recoil damage.",
    ...
    },
    {
        ...
        "effect": "Prevents being KOed from full HP, leaving 1 HP instead.  Protects against the one-hit KO moves regardless of HP."
    },
    {
        "id": 49,
        "name": "flame-body",
        "description": "Burns the foe on contact.",
        "effect": "Has a 30% chance of burning attacking Pokémon on contact."
    },
    {
        "id": 12,
        "name": "oblivious",
    ...
    },
    {
        "id": 144,
        "name": "regenerator",
        "description": "Restores a little HP when\nwithdrawn from battle.",
    ...
    },
    {
        ...
        "effect": "Prevents steel opponents from fleeing or switching out."
    },
    {
        "id": 148,
        "name": "analytic",
        "description": "Boosts move power when\nthe Pokémon moves last.",
    ...
    },
    {
        "id": 93,
        "name": "hydration",
        "description": "Heals status problems if\nit is raining.",
        "effect": "Cures any major status ailment after each turn during rain."
    },
    {
        "id": 115,
        "name": "ice-body",
        "description": "The Pokémon regains HP in\na hailstorm.",
    ...
    },
    {
        "id": 143,
        "name": "poison-touch",
        "description": "May poison targets when a\nPokémon makes contact.",
        "effect": "Has a 30% chance of poisoning target Pokémon upon contact."
    },
    {
        "id": 75,
        "name": "shell-armor",
        "description": "Blocks critical hits.",
        "effect": "Protects against critical hits."
    },
    {
        "id": 92,
        "name": "skill-link",
        "description": "Increases the frequency\nof multi-strike moves.",
    ...
    },
    {
        "id": 130,
        "name": "cursed-body",
        "description": "May disable a move used\non the Pokémon.",
        "effect": "Has a 30% chance of Disabling any move that hits the Pokémon."
    },
    {
        "id": 133,
        "name": "weak-armor",
        "description": "Physical attacks lower\nDefense and raise Speed.",
    ...
    },
    {
        "id": 108,
        "name": "forewarn",
        "description": "Determines what moves\nthe foe has.",
    ...
    },
    {
        ...
        "effect": "Prevents Attack from being lowered by other Pokémon."
    },
    {
        "id": 43,
        "name": "soundproof",
    ...
    },
    {
        "id": 106,
        "name": "aftermath",
        "description": "Damages the foe landing\nthe finishing hit.",
        "effect": "Damages the attacker for 1/4 its max HP when knocked out by a contact move."
    },
    {
        "id": 139,
        "name": "harvest",
        "description": "May create another\nBerry after one is used.",
    ...
    },
    {
        "id": 120,
        "name": "reckless",
        "description": "Powers up moves that\nhave recoil damage.",
        "effect": "Strengthens recoil moves to 1.2× their power."
    },
    {
        "id": 84,
        "name": "unburden",
        "description": "Raises Speed if a held\nitem is used.",
        "effect": "Doubles Speed upon using or losing a held item."
    },
    {
        "id": 89,
        "name": "iron-fist",
        "description": "Boosts the power of\npunching moves.",
        "effect": "Strengthens punch-based moves to 1.2× their power."
    },
    {
        "id": 256,
        "name": "neutralizing-gas",
        "description": "If the Pokémon with Neutralizing Gas is in the battle,\nthe effects of all Pokémon’s Abilities will be nullified\nor will not be triggered.",
    ...
    },
    {
        "id": 131,
        "name": "healer",
        "description": "May heal an ally’s status\nconditions.",
        "effect": "Has a 30% chance of curing each adjacent ally of any major status ailment after each turn."
    },
    {
        "id": 102,
        "name": "leaf-guard",
        "description": "Prevents status problems\nin sunny weather.",
        "effect": "Protects against major status ailments during strong sunlight."
    },
    {
        "id": 113,
        "name": "scrappy",
        "description": "Enables moves to hit\nGhost-type foes.",
    ...
    },
    {
        "id": 111,
        "name": "filter",
        "description": "Powers down super­\neffective moves.",
        "effect": "Decreases damage taken from super-effective moves by 1/4."
    },
    {
        "id": 104,
        "name": "mold-breaker",
        "description": "Moves can be used\nregardless of abilities.",
        "effect": "Bypasses targets' abilities if they could hinder or prevent a move."
    },
    {
        "id": 153,
        "name": "moxie",
        "description": "Boosts Attack after\nknocking out any Pokémon.",
        "effect": "Raises Attack one stage upon KOing a Pokémon."
    },
    {
        "id": 155,
        "name": "rattled",
        "description": "Some move types scare\nit and boost its Speed.",
        "effect": "Raises Speed one stage upon being hit by a dark, ghost, or bug move."
    },
    {
        "id": 150,
        "name": "imposter",
        "description": "It transforms itself into\nthe Pokémon it is facing.",
        "effect": "Transforms upon entering battle."
    },
    {
        "id": 91,
        "name": "adaptability",
        "description": "Powers up moves of the\nsame type.",
        "effect": "Increases the same-type attack bonus from 1.5× to 2×."
    },
    {
        "id": 107,
        "name": "anticipation",
        "description": "Senses the foe’s\ndangerous moves.",
        "effect": "Notifies all trainers upon entering battle if an opponent has a super-effective move, self destruct, explosion, or a one-hit KO move."
    },
    {
        "id": 10,
        "name": "volt-absorb",
    ...
    },
    {
        "id": 95,
        "name": "quick-feet",
        "description": "Boosts Speed if there is a\nstatus problem.",
        "effect": "Increases Speed to 1.5× with a major status ailment."
    },
    {
        "id": 36,
        "name": "trace",
    ...
    },
    {
        "id": 88,
        "name": "download",
        "description": "Adjusts power according\nto the foe’s ability.",
        "effect": "Raises the attack stat corresponding to the opponents' weaker defense one stage upon entering battle."
    },
    {
        "id": 46,
        "name": "pressure",
    ...
    },
    {
        "id": 81,
        "name": "snow-cloak",
        "description": "Raises evasion in a\nhailstorm.",
        "effect": "Increases evasion to 1.25× during hail.  Protects against hail damage."
    },
    {
        "id": 63,
        "name": "marvel-scale",
        "description": "Ups DEFENSE if suffering.",
        "effect": "Increases Defense to 1.5× with a major status ailment."
    },
    {
        "id": 136,
        "name": "multiscale",
